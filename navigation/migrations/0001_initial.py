    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('duration', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True, verbose_name='Общее время')),
                ('distance', models.DecimalField(blank=True, decimal_places=2, max_digits=7, null=True, verbose_name='Общая дистанция')),
